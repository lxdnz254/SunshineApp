...
package com.lxdnz.nz.sunshine.app.sync;
...
import com.lxdnz.nz.sunshine.app.BuildConfig;
...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final String ACTION_DATA_UPDATED =
            "com.lxdnz.nz.sunshine.app.ACTION_DATA_UPDATED";
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        ...
        // longitude, in case we are syncing based on a new PlacePicker API result.
        ...
        try {
            ...
            // Instead of always building the query based of the location string, we want to
            // potentially build a query using lat/lon value. This will be the case when we
            // are syncing based off of a new location from the PlacePicker API. So we need
            // to check if we have a lat/lon to work with, and use those when we do.
            // Otherwise, the weather service may not understand the location address
            // provided by the PlacePicker API and the user could end up with no weather!
    ...
    private void getWeatherDataFromJson(String forecastJsonStr,
        ...
        try {
            ...
            //do we have an error?
            if(forecastJson.has(OWM_WEATHER_CODE)) {
                int errorCode = forecastJson.getInt(OWM_WEATHER_CODE);
    ...
    private void updateWidgets() {
        Context context = getContext();
        // Setting the package ensures only components in our app will receive the broadcast.
    ...
    /**
     * Set the location status into shared preference. This function should not be called from the
